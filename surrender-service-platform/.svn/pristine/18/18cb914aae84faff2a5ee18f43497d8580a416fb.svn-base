...
public interface SurrenderTraceBO {
	 ...
	 * @param ykSurrenderTrace
	 */
	 void updateSurrenderTrace(SurrenderConfirmResDTO surrenderConfirmResDTO , BigDecimal surrenderTraceSid, long confirmStartTime);
