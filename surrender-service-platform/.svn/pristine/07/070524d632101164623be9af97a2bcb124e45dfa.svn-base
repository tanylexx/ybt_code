...
@Component("calPolicyCashValueBatchImpl")
public class CalPolicyCashValueBatchImpl implements MultThreadBatch{
	@Autowired
	...
	public List<?> executeData() throws Exception {
		return queryPolicyCashValueReqDTOBO.queryPrecalculatedParam();
	}
